...
export default function UsedBikesBanner() {
  return (
    <section className="w-full bg-background py-20 border-t border-background relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-1 bg-linear-to-r from-transparent via-blood to-transparent opacity-50" />
      ...
      <div className="max-w-[1440px] mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {/* Punto 1 */}
          <div className="bg-surface p-8 border border-assets hover:border-blood/80 transition-colors group">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href={routes.catalog.subcategory("bicicletas", "usados")}
            className="px-8 py-4 bg-foreground hover:bg-blood text-background font-epilogue font-bold uppercase tracking-wider text-sm transition-all shadow-lg flex items-center gap-2 w-full sm:w-auto justify-center"
          >
          ...
          <Link
            href="/vender"
            className="px-8 py-4 bg-background border border-gray-300 hover:border-foreground text-foreground font-epilogue font-bold uppercase tracking-wider text-sm transition-all flex items-center gap-2 w-full sm:w-auto justify-center"
          >
