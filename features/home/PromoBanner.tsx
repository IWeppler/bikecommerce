    ...
    <section className="w-full bg-foreground text-white overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[500px] lg:h-[600px]">
        ...
        <div className="flex flex-col justify-center p-8 md:p-16 lg:p-24 relative z-10">
          <div className="inline-flex items-center gap-2 text-swiss-blood font-bold uppercase tracking-widest text-xs mb-6 animate-pulse">
          ...
          <p className="font-manrope text-paragraph text-lg leading-relaxed mb-8 max-w-md">
            Llegó la nueva serie <strong>Turbo Levo SL</strong>. Un cuadro de carbono tan ligero que olvidarás que es eléctrica, hasta que sientas el empuje.
          </p>

          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              href="/categoria/bicicletas/e-mtb"
              className="px-8 py-4 bg-swiss-blood hover:bg-red-700 text-white font-epilogue font-bold uppercase tracking-wider text-sm transition-all flex items-center justify-center gap-2 group w-full sm:w-auto"
            >
              Ver E-Bikes
            ...
            <div className="flex items-center justify-center sm:justify-start gap-4 px-4">
               <div className="text-center">
                 <span className="block font-bold text-2xl font-epilogue">120<span className="text-xs align-top">km</span></span>
                 <span className="text-xs text-paragraph uppercase tracking-widest">Autonomía</span>
               </div>
               <div className="w-px h-8 bg-white/20"></div>
               <div className="text-center">
                 <span className="block font-bold text-2xl font-epilogue">17.3<span className="text-xs align-top">kg</span></span>
                 <span className="text-xs text-paragraph uppercase tracking-widest">Peso Total</span>
               </div>
            </div>
          </div>
        </div>
